...
<ul class="shopping-list">
    ...
    $sel = $connect->query("SELECT * FROM cart")->fetch_assoc();
    $Pid = $sel["product_id"];
    $sell = $connect->query("SELECT * FROM products WHERE id = '$Pid'");

    foreach ($sell as $key => $pr):
    ?>
<li>
<a href="javascript:void(0)" class="remove" title="Remove this item"><i class="lni lni-close"></i></a>
<div class="cart-img-head">
<a class="cart-img" href="product-details.html"><img src="../admin/images/<?= $pr["img"] ?>" alt="#"></a>
</div>
<div class="content">
<h4><a href="product-details.html">
<?= $pr["name"] ?></a></h4>
<p class="quantity"><?= $sel["count"] ?>x - <span class="amount">$<?= $pr["price"] ?></span></p>
</div>
</li>
<?php endforeach?>
<!-- <li>
...
<img src="../admin/images/<?= $pro["img"] ?>" alt="#">
<div class="button">
<button  class="btn addCart" product_id="<?= $pro["id"] ?>"><i class="lni lni-cart"></i> Add to Cart</button>
</div>
</div>
 <div class="product-info">
<span class="category">Watches</span>
<h4 class="title">
<a href="product-grids.html"><?= $pro["name"] ?></a>
</h4>
<ul class="review">
...
$(".addCart").click(function(){
    ...
    $.post("addCart.php" , {product_id:product_id} , function(data){
        console.log(data);
