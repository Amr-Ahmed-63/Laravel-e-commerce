...
<div class="product-image">
    ...
    <img style="height:300px;" style="width: 100%" src="{{asset("storage/images/".$img->image)}}" alt="#">
    @endif
    @endforeach
    @if("" != Session::get("id"))
    ...
    <div class="button">
        <form action="{{route("cart.show",$pro->id)}}" method="GET">
            @csrf
            <button type="submit" class="btn addCart" product_id=""><i class="lni lni-cart"></i> Add to Cart</button>
        </form>
    </div>

@else
<div class="button">
    <a href="user">Add To Cart</a>
</div>

@endif
</div>
 <div class="product-info">
<span class="category">{{$pro->category}}</span>
<h4 class="title">
...
<div class="single-product">
<div class="product-image">
<img src="{{ asset("web") }}/images/products/product-4.jpg" alt="#">
...
<div class="single-product">
<div class="product-image">
<img src="{{ asset("web") }}/images/products/product-5.jpg" alt="#">
<div class="button">
<a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
</div>
</div>
...
<div class="single-product">
<div class="product-image">
<img src="{{ asset("web") }}/images/products/product-7.jpg" alt="#">
